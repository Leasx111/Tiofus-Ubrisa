...
var DecompressorUtils = load("res://addons/godot_super-wakatime/decompressor.gd").new()
...
var ApiKeyPrompt: PackedScene = load("res://addons/godot_super-wakatime/api_key_prompt.tscn")
var Counter: PackedScene = load("res://addons/godot_super-wakatime/counter.tscn")
